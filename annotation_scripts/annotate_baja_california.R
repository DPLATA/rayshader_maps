...
img <- image_read("hd_imgs/baja_california.png")
...
img |> 
  ...
  image_annotate("Densidad poblacional de Baja California",
                 gravity = "northwest",
                 location = "+50+50",
                 color = text_color,
                 size = 90,
  ...
  image_annotate(glue("Gráfica por Diego Plata (@foreverpelon) | ",
                 ...
                 size = 35) |> 
  image_write("annotated_hd_imgs/annotated_hd_baja_california.png")
