...
img <- image_read("hd_imgs/aguascalientes.png")
...
img |> 
  ...
  image_annotate("Densidad poblacional de Aguascalientes",
                 gravity = "northwest",
                 location = "+50+50",
                 color = text_color,
                 size = 100,
  ...
  image_annotate(glue("Gráfica por Diego Plata (@foreverpelon) | ",
                 ...
                 size = 35) |> 
  image_write("annotated_hd_imgs/annotated_hd_aguascalientes.png")
