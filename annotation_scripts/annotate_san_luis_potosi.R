...
img <- image_read("hd_imgs/san_luis_potosi.png")
...
img |> 
  ...
  image_annotate("Densidad poblacional de San Luis Potosí",
                 gravity = "northwest",
                 location = "+75+50",
                 color = text_color,
                 size = 100,
  ...
  image_annotate(glue("Gráfica por Diego Plata (@foreverpelon) | ",
                 ...
                 size = 35) |> 
  image_write("annotated_hd_imgs/annotated_hd_san_luis_potosí.png")
